...
//
//    @Bean //ResidentService 에 들어간 AuthenticationManger 빈 등록 오류로 추가한 코드
...
////                .requestMatchers("/h2-console/**","/repository/**","/service/**","/172.20.14.41:8082/**").permitAll()
